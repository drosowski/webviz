...
//                ).waitFor();
    ...
    public static String drawGraph(Context ctx, Object obj) {
        return drawGraph(ctx, obj, ctx.nextFileName());
    }

    public static String drawGraphToFile(Object obj, String file) {
        return drawGraph(defaultContext, obj, file);
    }

    public static String drawGraph(Object obj) {
        return drawGraph(defaultContext, obj);
    }
